...
TEST_F(CertificatesTablesTest, test_only_store_non_special_case) {
  ...
  parseSystemStoreString(input, storeLocation, serviceNameOrUserId, sid, storeName);
...
TEST_F(CertificatesTablesTest, test_user_classes) {
  LPCWSTR input = L"S-1-5-21-2821152761-3909955410-1545212275-1001_Classes\\Root";
  std::string storeLocation = "Users";
  std::string serviceNameOrUserId, sid, storeName; 

  parseSystemStoreString(input, storeLocation, serviceNameOrUserId, sid, storeName);

  EXPECT_EQ(serviceNameOrUserId, "S-1-5-21-2821152761-3909955410-1545212275-1001_Classes");
